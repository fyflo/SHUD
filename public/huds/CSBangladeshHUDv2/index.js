...
function updatePlayerNames(allplayers) {
  ...
  Object.values(allplayers).forEach((player) => {
    ...
    if (playerContainer.length) {
      ...
      playerContainer.find(".player_section_bottom #player_alias_text").text(playerName);
    }
  });
}
