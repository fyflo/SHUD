...
function showUpdateNotification(currentVersion, latestVersion) {
  ...
  notification.innerHTML = `
        <div>
            <h3 style="margin-top: 0; color: #4CAF50;" data-i18n="updateAvailable">Доступно обновление!</h3>
            <p ><span data-i18n="currentVersion"></span>${currentVersion}</p>
            <p ><span data-i18n="latestVersion"></span>${latestVersion}</p>
            <div style="display: flex; justify-content: space-between; margin-top: 15px;">
                <a href="https://github.com/fyflo/SHUD/releases/latest" target="_blank" 
                   ...
                   border-radius: 4px; text-decoration: none;" data-i18n="downloadUpdate">Скачать обновление</a>
                <button style="background-color: transparent; color: #aaa; border: 1px solid #aaa; 
                       padding: 8px 16px; border-radius: 4px; cursor: pointer;" data-i18n="close">Закрыть</button>
            </div>
        </div>
    `;
