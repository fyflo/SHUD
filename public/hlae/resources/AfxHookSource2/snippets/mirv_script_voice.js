"use strict";
{
    ...
    let value = 'default';
    // @ts-ignore
    if (mirv._mirv_script_voice !== undefined)
        mirv._mirv_script_voice.unregister();
    // @ts-ignore
    ...
    // @ts-ignore
    mirv._mirv_script_voice.register('mirv_script_voice', 'Easier frontend to tv_listen_voice_indices / tv_listen_voice_indices_h');
}
